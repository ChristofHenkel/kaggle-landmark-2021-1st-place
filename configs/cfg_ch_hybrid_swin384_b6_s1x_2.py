...
# MODEL
cfg.model = "ch_mdl_hybrid_transformer"
cfg.embedder = "tf_efficientnet_b6_ns"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_hybrid_swin384_b6_s1x/fold0/checkpoint_last_seed304247_e5.pth'
cfg.pretrained_weights_strict = True
# cfg.pop_weights = ['patch_embed']
# DATASET
cfg.dataset = "ch_ds_1"
