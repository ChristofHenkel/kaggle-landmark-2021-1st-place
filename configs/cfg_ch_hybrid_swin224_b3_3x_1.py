...
# MODEL
cfg.model = "ch_mdl_hybrid_transformer_3x"
cfg.embedder = "tf_efficientnet_b3_ns"
cfg.backbone = "swin_base_patch4_window7_224"
# cfg.freeze_backbone_head = True
cfg.find_unused_parameters = True
cfg.neck = "option-D"
cfg.embedding_size = 512
cfg.pool = "gem"
cfg.gem_p_trainable = True
cfg.pretrained_weights='/mount/glr2021/models/cfg_ch_hybrid_swin224_2x_b3_cutout_s2x/fold0/checkpoint_last_seed428213.pth'
